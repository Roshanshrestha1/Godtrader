# 🚀 AI Trading System - Complete Documentation (A-Z)
...
│                                                             │
│  1. Fetches data for 108 assets (Yahoo Finance/TradingView) │
...
### Secondary Source: TradingView (Conceptual)
- *Note: Direct TradingView API requires paid plan. Current implementation uses Yahoo as primary stable source.*
- **Future Expansion:** Can integrate `tradingview-ta` library for technical analysis summaries if needed.
...
2. **Install Requirements:**
   ```bash
   pip install pandas>=2.2.0 numpy python-telegram-bot yfinance ta-lib pyyaml logging
   ```
